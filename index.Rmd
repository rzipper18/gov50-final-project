...
scatterplot <- ggplot(congress_and_poverty, aes(x = poverty_rate, y = nominate_dim1)) +
  ...
  labs(x = "Congressional District Poverty Rate",
       ...
       title = "Congressional District Poverty Rate and U.S. Representative Economic Ideology") +
