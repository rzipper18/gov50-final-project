...
cor(congress_and_poverty$poverty_rate, congress_and_poverty$nominate_dim1, use = "complete.obs")
  
```

The correlation between poverty rate and DW-NOMINATE score is approximately -0.2. Members of Congress representing high-poverty districts are more likely to support ideologically progressive economic policies. 
